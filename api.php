...
Route::get('notificationsview', [NotificationsController::class, 'Notifications_viewbadgescount']);
Route::get('notificationsshow', [NotificationsController::class, 'Notifications_showlistupdatenotify']);
